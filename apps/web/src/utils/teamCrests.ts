...
// Updated to fix incorrect badge mappings identified in GitHub Issue #5
export const teamCrests: Record<string, string> = {
  ...
  'AFC Bournemouth': 'https://resources.premierleague.com/premierleague/badges/70/t91.png', // Updated team name
  Bournemouth: 'https://resources.premierleague.com/premierleague/badges/70/t91.png', // Fallback
  ...
  // Historical Premier League Teams - CORRECTED BADGES
  // Issue #5: Fixed incorrect badge mappings for Norwich, Wigan, Blackpool, Portsmouth
  ...
  // Norwich City - Using API-Sports reliable logo service
  'Norwich City': 'https://media.api-sports.io/football/teams/1370.png',
  ...
  // Middlesbrough - Using API-Sports reliable logo service
  Middlesbrough: 'https://media.api-sports.io/football/teams/1371.png',

  Sunderland: 'https://resources.premierleague.com/premierleague/badges/70/t24.png',
  // Bolton Wanderers - Fixed: now using Portsmouth's previous t30 ID
  'Bolton Wanderers': 'https://resources.premierleague.com/premierleague/badges/70/t30.png',

  // Wigan Athletic - Using API-Sports reliable logo service
  'Wigan Athletic': 'https://media.api-sports.io/football/teams/1372.png',

  // Blackpool - Fixed: was incorrectly assigned Charlton's badge, now using correct t16 ID
  Blackpool: 'https://resources.premierleague.com/premierleague/badges/70/t16.png',
  ...
  // Portsmouth - Fixed: was incorrectly assigned Bolton's badge, now using correct t32 ID
  Portsmouth: 'https://resources.premierleague.com/premierleague/badges/70/t32.png',
  ...
  // Charlton Athletic - Fixed: now using Blackpool's previous t33 ID
  'Charlton Athletic': 'https://resources.premierleague.com/premierleague/badges/70/t33.png',
